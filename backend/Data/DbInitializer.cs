    ...
    public static void Seed(IApplicationBuilder applicationBuilder)
    {
        ...
        var productCategories = new List<ProductCategory>(){
            new()
            {
                ...
                ImagePath = $"api/Images/{nameof(ProductCategory)}/1.webp"
            ...
            new()
            {
                ...
                ImagePath = $"api/Images/{nameof(ProductCategory)}/2.webp"
            },
            new()
            {
                Id = 3,
                ...
                ImagePath = $"api/Images/{nameof(ProductCategory)}/3.webp"
            },
            new()
            {
                Id = 4,
                ...
                ImagePath = $"api/Images/{nameof(ProductCategory)}/4.webp"
            },
            new()
            {
                Id = 5,
                ...
                ImagePath = $"api/Images/{nameof(ProductCategory)}/5.webp"
            },
            new()
            {
                Id = 6,
                ...
                ImagePath = $"api/Images/{nameof(ProductCategory)}/6.webp"
            },
            new()
            {
                Id = 7,
                ...
                ImagePath = $"api/Images/{nameof(ProductCategory)}/7.webp"
            },
            new()
            {
                Id = 8,
                ...
                ImagePath = $"api/Images/{nameof(ProductCategory)}/8.webp"
            },
            new()
            {
                Id = 9,
                ...
                ImagePath = $"api/Images/{nameof(ProductCategory)}/9.webp"
            }
        };
        ...
        var users = new List<User>(){
            new(){
                ...
                PostalCode = "1086",
                CountryWithVat = countriesWithVat[12],
                ImagePath = $"api/Images/{nameof(User)}/1.webp"
            },
            new(){
                Id = 2,
                Username = "JaneDoe",
        ...
        var products = new List<Product>(){
            new(){
                ...
                Featured = false,
                Discontinued = true,
                ImagePath = $"api/Images/{nameof(Product)}/1.webp",
            },
            new(){
                Id = 2,
                ...
                Featured = false,
                Discontinued = true,
                ImagePath = $"api/Images/{nameof(Product)}/2.webp",
            },
            new(){
                Id = 3,
                ...
                Featured = true,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/3.webp",
            },
            new(){
                Id = 4,
                ...
                Featured = true,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/4.webp",
            },
            new(){
                Id = 5,
                ...
                Featured = true,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/5.webp",
            },
            new(){
                Id = 6,
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/6.webp",
            },
            new(){
                Id = 7,
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/7.webp",
            },
            new(){
                Id = 8,
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/8.webp",
            },
            new(){
                Id = 9,
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/9.webp",
            },
            new(){
                Id = 10,
                Category = context.ProductCategories.Where(x => x.Id == 6).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/10.webp",
            },
            new(){
                Id = 11,
                Category = context.ProductCategories.Where(x => x.Id == 6).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/11.webp",
            },
            new(){
                Id = 12,
                Category = context.ProductCategories.Where(x => x.Id == 1).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/12.webp",
            },
            new(){
                Id = 13,
                Category = context.ProductCategories.Where(x => x.Id == 1).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/13.webp",
            },
            new(){
                Id = 14,
                Category = context.ProductCategories.Where(x => x.Id == 9).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/14.webp",
            },
            new(){
                Id = 15,
                Category = context.ProductCategories.Where(x => x.Id == 9).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/15.webp",
            },
            new(){
                Id = 16,
                Category = context.ProductCategories.Where(x => x.Id == 7).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/16.webp",
            },
            new(){
                Id = 17,
                Category = context.ProductCategories.Where(x => x.Id == 7).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/17.webp",
            },
            new(){
                Id = 18,
                Category = context.ProductCategories.Where(x => x.Id == 5).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/18.webp",
            },
            new(){
                Id = 19,
                Category = context.ProductCategories.Where(x => x.Id == 5).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/19.webp",
            },
            new(){
                Id = 20,
                Category = context.ProductCategories.Where(x => x.Id == 2).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/20.webp",
            },
            new(){
                Id = 21,
                Category = context.ProductCategories.Where(x => x.Id == 2).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/21.webp",
            },
            new(){
                Id = 22,
                Category = context.ProductCategories.Where(x => x.Id == 8).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/22.webp",
            },
            new(){
                Id = 23,
                Category = context.ProductCategories.Where(x => x.Id == 8).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/23.webp",
            },
            new(){
                Id = 24,
                Category = context.ProductCategories.Where(x => x.Id == 4).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/24.webp",
            },
            new(){
                Id = 25,
                Category = context.ProductCategories.Where(x => x.Id == 4).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/25.webp",
            },
            new(){
                Id = 26,
                Category = context.ProductCategories.Where(x => x.Id == 3).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/26.webp",
            },
            new(){
                Id = 27,
                Category = context.ProductCategories.Where(x => x.Id == 3).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/27.webp",
            },
            new(){
                Id = 28,
                Category = context.ProductCategories.Where(x => x.Id == 6).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/28.webp",
            },
            new(){
                Id = 29,
                Category = context.ProductCategories.Where(x => x.Id == 1).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/29.webp",
            },
            new(){
                Id = 30,
                Category = context.ProductCategories.Where(x => x.Id == 9).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/30.webp",
            },
            new(){
                Id = 31,
                Category = context.ProductCategories.Where(x => x.Id == 1).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/31.webp",
            },
            new(){
                Id = 32,
                Category = context.ProductCategories.Where(x => x.Id == 6).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/32.webp",
            },
            new(){
                Id = 33,
                Category = context.ProductCategories.Where(x => x.Id == 3).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/33.webp",
            },
            new(){
                Id = 34,
                Category = context.ProductCategories.Where(x => x.Id == 3).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/34.webp",
            },
            new(){
                Id = 35,
                Category = context.ProductCategories.Where(x => x.Id == 6).First(),
                Title = "ASUS H570M-PLUS",
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/35.webp",
            },
            new(){
                Id = 36,
                Category = context.ProductCategories.Where(x => x.Id == 9).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/36.webp",
            },
            new(){
                Id = 37,
                Category = context.ProductCategories.Where(x => x.Id == 9).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/37.webp",
            },
            new(){
                Id = 38,
                Category = context.ProductCategories.Where(x => x.Id == 9).First(),
                ...
                Featured = false,
                Discontinued = false,
                ImagePath = $"api/Images/{nameof(Product)}/38.webp",
            },
