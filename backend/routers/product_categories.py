...
async def post_create_new_category(category: product_category_schemas.ProductCategoryInputPost, db: Session = Depends(get_db)):
...
async def patch_products_by_category_id(category_id: UUID4, category: product_category_schemas.ProductCategoryInputPatch, db: Session = Depends(get_db)):
